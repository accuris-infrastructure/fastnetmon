...
sub get_library_binary_build_from_google_storage {
    ...
    my $download_file_return_code =
        system("s3cmd --disable-multipart  --host=s3.us-east-005.backblazeb2.com --host-bucket=\"%(bucket).s3.us-east-005.backblazeb2.com\" get $binary_path /tmp/$dependency_archive_name >/dev/null 2>&1");
...
sub upload_binary_build_to_google_storage {
    ...
    my $upload_this_file =
        system("s3cmd --disable-multipart  --host=s3.us-east-005.backblazeb2.com --host-bucket=\"%(bucket).s3.us-east-005.backblazeb2.com\" put /tmp/$dependency_archive_name $binary_path");
